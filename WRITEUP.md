...
| GAP-03 | No `aws:SecureTransport` deny | 164.312(e)(1) Transmission security | **5.3.5** Transmission Security (§ 164.312(e)(1)); Table 25 (integrity controls and encryption in transit) | Open — left in the starter so the suite has a known fail-closed case | Planned — fail if the bucket policy does not deny HTTP | Policy |
