...
# Closed in this resource: server_side_encryption is nested and must
# live on the table. The CMK itself is in kms.tf.
######################################################################
...
#G6(OPEN): Leaving this as is for now.
...
# GAP-05: ENIs in the VPC require ec2:CreateNetworkInterface (not in BasicExecution).
...
# G7 (OPEN): Leaving this as is for now.
...
# GAP-05: security group is in hardening.tf; vpc_config stays nested here.
...
#G8(OPEN): Leaving this as is for now.
